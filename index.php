...
<html>
  ...
  <body>
      ...
      <div class="btn-group" role="group" aria-label="Basic example">
        <button type="submit" class="btn btn-secondary"name="4">4</button>
        <button type="submit" class="btn btn-secondary"name="5">5</button>
        <button type="submit" class="btn btn-secondary"name="6">6</button>
        <button type="submit" class="btn btn-secondary opt-btn"name="-">-</button>
      </div>
      <div class="btn-group" role="group" aria-label="Basic example">
        <button type="submit" class="btn btn-secondary"name="1">1</button>
        <button type="submit" class="btn btn-secondary"name="2">2</button>
        <button type="submit" class="btn btn-secondary"name="3">3</button>
        <button type="submit" class="btn btn-secondary opt-btn"name="+">+</button>
      </div>
      <div class="btn-group" role="group" aria-label="Basic example">
        <button type="submit" class="btn btn-secondary zero-btn"name="0">0</button>
